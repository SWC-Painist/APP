 ...
 * Use the {@link LoginBackgroundFragment#newInstance} factory method to
...
public class LoginBackgroundFragment extends Fragment {
    ...
    private final float cycleTime = 4.5f;

    private final float anchorX = 0f;
    private final float anchorY = 0f;

    private final float moveDistanceFrom = 500f;
    ...
    public LoginBackgroundFragment() {
        ...
        globalTimer.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                for(int i=0; i<noteNumber; i++) {
                    ...
                    transformImage(notes[i], positionX + anchorX, positionY * 1.7f + anchorY, alpha);
                }
            }
        });
